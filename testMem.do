...
add wave -position insertpoint  \
sim:/int/memory/u3/address
add wave -position insertpoint  \
sim:/int/memory/u3/we
add wave -position insertpoint  \
sim:/int/memory/u3/datain
add wave -position insertpoint  \
...
run
force -deposit sim:/int/IO_PORT 16#FFFF 0
run
force -deposit sim:/int/IO_PORT 16#F320 0
run
force -freeze sim:/int/IO_PORT 16#10 0
run
run
run
run
